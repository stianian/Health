package com.example.healthemanager1.ui.dashboard.widget;
...
public class CircleProgress1View extends View {
    ...
    public CircleProgress1View(Context context) {
        this(context, null);
    }

    public CircleProgress1View(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("ResourceAsColor")
    public CircleProgress1View(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mArcForePaint.setColor(Color.LTGRAY);//设置画笔颜色
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画百分比值弧线
        canvas.drawArc(mArcRectF, -90, mSweepAngle, false, mArcForePaint);//开始角度，旋转角度，0度在3点钟位置
        //画刻度线
